...
export default defineSchema({
  ...
  activities: defineTable({
    ...
    recordingId: v.optional(v.id("callRecordings")),
    createdAt: v.number(),
    updatedAt: v.number(),
  })
  ...
  notifications: defineTable({
    type: v.union(v.literal("deal_won"), v.literal("deal_lost"), v.literal("deal_stage_change"), v.literal("task_assigned"), v.literal("task_due_soon"), v.literal("task_overdue"), v.literal("contact_created"), v.literal("message_received"), v.literal("mention"), v.literal("system"), v.literal("badge_earned")),
    title: v.string(),
    message: v.string(),
    link: v.optional(v.string()),
    relatedEntityType: v.optional(v.union(v.literal("deal"), v.literal("contact"), v.literal("company"), v.literal("task"), v.literal("message"), v.literal("badge"))),
  ...
  // ============================================================================
  // COMMENTS - Collaborative commenting system for CRM entities
  // ============================================================================
  ...
  // ============================================================================
  // FIELD PERMISSIONS - Role-based field access control
  // ============================================================================
  fieldPermissions: defineTable({
    ...
    .index("by_entity_role", ["entityType", "role"])
    .index("by_entity_field_role", ["entityType", "field", "role"]),
  ...
  // ============================================================================
  // CALL RECORDINGS - Call recording storage and transcription
  // ============================================================================
  callRecordings: defineTable({
    ...
    transcriptionStatus: v.optional(v.union(v.literal("pending"), v.literal("processing"), v.literal("completed"), v.literal("failed"))),
    analysisStatus: v.optional(v.union(v.literal("pending"), v.literal("processing"), v.literal("completed"), v.literal("failed"))),
    ...
    .index("by_created", ["createdAt"])
    .searchIndex("search_transcriptions", {
      searchField: "transcription",
      filterFields: ["contactId", "dealId", "transcriptionStatus"],
    }),
  ...
  forecastSnapshots: defineTable({
    ...
    predictions: v.array(v.object({
      ...
      predictedCloseDate: v.optional(v.number()),
      category: v.union(v.literal("committed"), v.literal("best_case"), v.literal("pipeline"), v.literal("omitted")),
      aiAdjustedProbability: v.optional(v.number()),
  ...
  // ============================================================================
  // LEADERBOARDS - Sales gamification and performance tracking
  // ============================================================================
  ...
  leaderboardEntries: defineTable({
    ...
    .index("by_user", ["userId"])
    .index("by_leaderboard_rank", ["leaderboardId", "rank"])
